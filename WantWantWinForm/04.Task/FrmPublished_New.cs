...
{
    public partial class FrmPublished_New : Form
    {
        ...
        private void 已上架newform_Load(object sender, EventArgs e)
        {
        ...
        private void btn_UnPub_Click(object sender, EventArgs e)
        {
            try
            {
                var q =( from p in dbWantModel.TaskLists
                        where p.PublishOrNot == "立刻上架" && p.CaseID == ID
